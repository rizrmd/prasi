...
function autoprefixes(styles: Styles) {
  return Object.keys(styles).reduce<Styles>((obj, key) => {
    const value = autoprefix.convert(styles[key]);
    obj[key] = value;
    return obj;
  }, {});
}
...
function getResizerStyles(position: "left" | "right" | "top" | "bottom") {
  ...
  return [styles.resizer, autoprefix.convert(resizerStyle)];
}
      ...
      <div style={Object.assign({}, styles.wrapper, { zIndex })}>
        ...
        <div style={dockStyles}>
          ...
          <div style={styles.dockContent}>
            {typeof child === "object" && child instanceof Promise
              ? null
              : child}
          </div>
        </div>
